...
local entityold = {
    ...
    base_animation = {
        ...
        priority = "medium",
        scale = 1.25,
        shift = {-0.53149999999999995 * 1.25 - 0.15, -1.9375 * 1.25},
        width = 42
    },
    base_patch = {
        ...
        priority = "medium",
        scale = 1.25,
        shift = {0.03125 - 0.1, 0.203125 - 0.0},
        width = 69
    },
    charge_approach_distance = 5,
    charging_energy = "500kW",
    charging_offsets = {
        {-1.5 * 1.25, -0.5 * 1.25 - 0.4}, {1.5 * 1.25, -0.5 * 1.25 - 0.4},
        {1.5 * 1.25, 1.5 * 1.25 - 0.4}, {-1.5 * 1.25, 1.5 * 1.25 - 0.4}
    },
    ...
    collision_box = {{-1.7 * 1.25, -1.7 * 1.25}, {1.7 * 1.25, 1.7 * 1.25}},
    ...
    door_animation_down = {
        ...
        priority = "medium",
        scale = 1.25,
        shift = {0.015625 * 1.25, -0.234375 * 1.25},
        width = 52
    },
    door_animation_up = {
        ...
        priority = "medium",
        scale = 1.25,
        shift = {0.015625 * 1.25, -0.890625 * 1.25},
        width = 52
    },
    ...
    max_health = 500 / 2.0,
    minable = {mining_time = 0.1, result = "k-roboport"},
    name = "k-roboport",
    open_door_trigger_effect = {
        {
            sound = {filename = "__base__/sound/roboport-door.ogg", volume = 1},
            type = "play-sound"
        }
    },
    ...
    resistances = {
        {percent = 60, type = "fire"}, {percent = 30, type = "impact"}
    },
    robot_slots_count = 7 / 2.0,
    selection_box = {{-2 * 1.25, -2 * 1.25}, {2 * 1.25, 2 * 1.25}},
