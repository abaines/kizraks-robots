...
local technology_chest = {
    effects = {
        {recipe = "k-logistic-chest-passive-provider", type = "unlock-recipe"},
        {recipe = "k-logistic-chest-active-provider", type = "unlock-recipe"},
        {recipe = "k-logistic-chest-storage", type = "unlock-recipe"},
        {recipe = "k-logistic-chest-buffer", type = "unlock-recipe"},
        {recipe = "k-logistic-chest-requester", type = "unlock-recipe"}
    },
...
local technology_roboport = {
    effects = {{recipe = "k-roboport", type = "unlock-recipe"}},
...
local technology_robot = {
    effects = {
        {recipe = "k-flying-robot-frame", type = "unlock-recipe"},
        {recipe = "k-logistic-robot", type = "unlock-recipe"},
        {recipe = "k-construction-robot", type = "unlock-recipe"}
    },
    ...
    prerequisites = {
        "engine", "solar-energy", "circuit-network", "automation-2"
    }
}
