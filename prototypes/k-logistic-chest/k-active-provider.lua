...
local logistic_container = {
    ...
    max_health = 150,
    minable = {mining_time = 0.1, result = "k-logistic-chest-active-provider"},
    name = "k-logistic-chest-active-provider",
    open_sound = {
...
local item = {
    ...
    icon_size = 64,
    name = "k-logistic-chest-active-provider",
    order = "kizrak-b[storage]-c[logistic-chest-active-provider]",
    place_result = "k-logistic-chest-active-provider",
    stack_size = 5,
...
local recipe = {
    ...
    name = "k-logistic-chest-active-provider",
    results = {
        {type = "item", name = "k-logistic-chest-active-provider", amount = 1}
    },
